...
const form = reactive({
  ...
  status: props.thickness.status?.toString() || '1',
})

function handleSubmit() {
  router.put(`/thickness/${props.thickness.id}`, form)
}
