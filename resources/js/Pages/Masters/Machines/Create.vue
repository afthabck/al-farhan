...
<AppLayout>
  <div class="col-md-6 grid-margin stretch-card">
    <div class="card">
        ...
        <!--  -->
      <div class="card-body">
        <h6 class="card-title">Create Machine Type</h6>
        <form class="forms-sample" @submit.prevent="handleSubmit">
          <div class="form-group row">
            <label for="machine_name" class="col-sm-3 col-form-label">Machine Name</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" id="machine_name" v-model="form.machine_name" placeholder="Machine Name" />
